package com.pereiracorp.money.api.exceptionhandler;
...
public class MoneyExceptionHandler extends ResponseEntityExceptionHandler{
	...
	private List<Erro> criarListaDeErros(BindingResult bindingResult){
		...
		for (FieldError fieldError : bindingResult.getFieldErrors()) {
			...
			String mensagemDesenvolvimento = fieldError.toString();
			erros.add(new Erro(mensagemUsuario,mensagemDesenvolvimento));
		}
